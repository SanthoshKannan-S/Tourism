 ...
 * @author BaLa
 */
public class deleteguide extends javax.swing.JFrame {

    /**
     * Creates new form deleteguide
     */
    public deleteguide() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String guide1=jTextField1.getText();
        ...
        if(a==0)
        {
            try
            {
                Connection con=ConnectionProvider.getCon();
                Statement st=con.createStatement();
                st.executeUpdate("delete from guide where empid='"+guide1+"'");
                setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteguide.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
